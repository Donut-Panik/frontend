...
export const _ModalInfo: FC<Props> = ({ isVisible }) => {
  return (
    <Wrapper>
      ...
      <Text>
        Для получения NFT нужно выполнить все ежедневные задания 5 дней подряд. После
        получения ваш NFT будет стоить n₽, но его стоимость можно будет увеличить выполняя
        уже разблокированные еженедельные задания. Доступно n уровней улучшения NFT.
